...
func (o *Options) AddFlags(flags *pflag.FlagSet) {
	...
	flags.IntVar(&o.ConcurrentNebulaCronBackupSyncs, "concurrent-nebulacronbackup-syncs", 5, "The number of NebulaCronBackup objects that are allowed to sync concurrently.")
