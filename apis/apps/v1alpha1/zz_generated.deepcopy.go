...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CoredumpPreservSpec) DeepCopyInto(out *CoredumpPreservSpec) {
	*out = *in
	...
	if in.MaxTimeKept != nil {
		in, out := &in.MaxTimeKept, &out.MaxTimeKept
		*out = new(string)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CoredumpPreservSpec.
func (in *CoredumpPreservSpec) DeepCopy() *CoredumpPreservSpec {
	if in == nil {
		return nil
	}
	out := new(CoredumpPreservSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NebulaClusterSpec) DeepCopyInto(out *NebulaClusterSpec) {
	*out = *in
	...
	if in.CoredumpPreservation != nil {
		in, out := &in.CoredumpPreservation, &out.CoredumpPreservation
		*out = new(CoredumpPreservSpec)
		(*in).DeepCopyInto(*out)
	}
}
...
func (in *StoragedStatus) DeepCopyInto(out *StoragedStatus) {
	*out = *in
	...
	if in.HostInfo != nil {
		in, out := &in.HostInfo, &out.HostInfo
		*out = make(map[string]HostInfo, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
