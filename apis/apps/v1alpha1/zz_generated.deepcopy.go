...
func (in *ScheduledBackupStatus) DeepCopyInto(out *ScheduledBackupStatus) {
	*out = *in
	if in.CurrPauseStatus != nil {
		in, out := &in.CurrPauseStatus, &out.CurrPauseStatus
		*out = new(bool)
		**out = **in
	}
	...
	if in.NumberOfSuccessfulBackups != nil {
		in, out := &in.NumberOfSuccessfulBackups, &out.NumberOfSuccessfulBackups
		*out = new(int32)
		**out = **in
	}
	if in.NumberOfFailedBackups != nil {
		in, out := &in.NumberOfFailedBackups, &out.NumberOfFailedBackups
		*out = new(int32)
		**out = **in
	}
